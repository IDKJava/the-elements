...
Java_sand_wallpaper_opengl_DemoRenderer_nativeResize(JNIEnv* env, jobject thiz, jint width, jint height)
{
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_nativeLoadState(JNIEnv* env, jobject thiz, jboolean shouldLoadDemo)
{
    char loadLoc[256];
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoRenderer_nativeRender(JNIEnv* env, jobject thiz)
{
    glRenderThreaded();
}
...
Java_sand_wallpaper_opengl_DemoActivity_saveState(JNIEnv* env, jobject thiz, jbyteArray saveLoc)
{
#ifdef USE_PROFILING
    // Stop profiling
...
JNIEXPORT char JNICALL
Java_sand_wallpaper_opengl_DemoActivity_loadState(JNIEnv* env, jobject thiz, jbyteArray loadLoc)
{
...
JNIEXPORT char JNICALL
Java_sand_wallpaper_opengl_DemoActivity_saveTempState(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT char JNICALL
Java_sand_wallpaper_opengl_DemoActivity_loadDemoState(JNIEnv* env, jobject thiz)
{
    char loadLoc[256];
    strcpy(loadLoc, ROOT_FOLDER);
    strcat(loadLoc, SAVES_FOLDER);
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoRenderer_nativeInit(JNIEnv* env, jobject thiz)
{
    // Initialization
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_nativeRefreshElements(JNIEnv* env, jobject thiz)
{
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_clearScreen(JNIEnv* env, jobject thiz)
{
    shouldClear = TRUE;
}
...
//Setter functions
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_preferences_Preferences_setBorderState(JNIEnv* env, jobject thiz, jboolean leftBorderState, jboolean topBorderState, jboolean rightBorderState, jboolean bottomBorderState)
{
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_Preferences_setAccelState(JNIEnv* env, jobject thiz, jboolean accelState)
{
    accelOn = (char) accelState;
}
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_Preferences_setFlippedState(JNIEnv* env, jobject thiz, jboolean flippedState)
{
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_Preferences_setAtmosphereTemp(JNIEnv* env, jobject thiz, jchar temp)
{
    cAtmosphere->heat = temp;
}
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_Preferences_setAtmosphereGravity(JNIEnv* env, jobject thiz, jfloat gravity)
{
    cAtmosphere->gravity = gravity;
}
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_Preferences_setZoom(JNIEnv* env, jobject thiz, jint zoom)
{
    if(zoom != zoomFactor)
    {
        zoomFactor = zoom;
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setPlayState(JNIEnv* env, jobject thiz, jboolean playState)
{
    play = (char) playState;
}
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setElement(JNIEnv* env, jobject thiz, jchar element)
{
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setBrushSize(JNIEnv* env, jobject thiz, jchar brushSizeValue)
{
    brushSize = brushSizeValue;
}
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setMouseLocation(JNIEnv* env, jobject thiz, jchar state, jint x, jint y)
{
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setFilterMode(JNIEnv* env, jobject thiz, jchar mode)
{
  filterType = mode;
}

JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setPinchScale(JNIEnv* env, jobject thiz, jfloat scale)
{
  zoomScale = scale;
}
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setPinchActive(JNIEnv* env, jobject thiz, jchar active)
{
    isPinch = active;
    if (!active) 
    {
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setIsPanMode(JNIEnv* env, jobject thiz, jchar isPan)
{
  isPanMode = isPan;
}
...
//Getter functions
JNIEXPORT char JNICALL
Java_sand_wallpaper_opengl_DemoActivity_getElement(JNIEnv* env, jobject thiz)
{
    return cElement->index;
}
JNIEXPORT char JNICALL
Java_sand_wallpaper_opengl_DemoActivity_getElementRed(JNIEnv* env, jobject thiz, int i)
{
...
JNIEXPORT char JNICALL
Java_sand_wallpaper_opengl_DemoActivity_getElementGreen(JNIEnv* env, jobject thiz, int i)
{
	if (i >= 0 && i < numElements) {
...
JNIEXPORT char JNICALL
Java_sand_wallpaper_opengl_DemoActivity_getElementBlue(JNIEnv* env, jobject thiz, int i)
{
	if (i >= 0 && i < numElements) {
...
Java_sand_wallpaper_opengl_DemoActivity_getElementInfo(JNIEnv* env, jobject thiz, int i)
{
...
Java_sand_wallpaper_opengl_DemoActivity_getMaxSpecials(JNIEnv* env, jobject thiz)
{
    return MAX_SPECIALS;
}
...
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setXGravity(JNIEnv* env, jobject thiz, float xGravityIn)
{
    xGravity = xGravityIn;
}
JNIEXPORT void JNICALL
Java_sand_wallpaper_opengl_DemoActivity_setYGravity(JNIEnv* env, jobject thiz, float yGravityIn)
{
    yGravity = yGravityIn;
}
...
Java_sand_wallpaper_opengl_SplashActivity_upgradeCustomElement(JNIEnv* env, jobject thiz, jstring filename)
{
...
JNIEXPORT jboolean JNICALL
Java_sand_wallpaper_opengl_SplashActivity_upgradeSaveFile(JNIEnv* env, jobject thiz, jstring filename)
{
    jboolean success = (jboolean) true;
    const char* nativeFilename = env->GetStringUTFChars(filename, NULL);
